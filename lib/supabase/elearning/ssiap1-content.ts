  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        "La main courante est le document central de la traçabilité SSIAP. L'agent y consigne toutes les événements selon la méthode SOCA : Situation (situer dans le temps et l'espace — quand, où, que faisait-on ?), Observation (faits objectifs observés sans interprétation), Causes/Conséquences (analyse des causes probables et évaluation des conséquences), Action (intervention réalisée ou mesure prise). Ce document aux pages numérotées constitue le journal de bord du poste de sécurité et peut être requis lors d'enquêtes ou de visites de la commission de sécurité.",
