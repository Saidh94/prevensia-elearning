...
export const ssiap1ModuleContent: ModuleContent = {
  ...
  deliveryFormat: "E-learning de sensibilisation théorique — préparation aux bases SSIAP1",
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        "Définition et obligation réglementaire : la main courante est un registre chronologique dans lequel l'agent SSIAP1 inscrit tous les événements, interventions, rondes, alarmes, anomalies et informations relatives à la sécurité incendie. L'arrêté du 2 mai 2005 modifié (formation SSIAP) impose sa tenue quotidienne comme compétence fondamentale de l'agent SSIAP1. Elle fait partie du registre de sécurité de l'établissement (Code de la construction, art. R.143-33).",
        "Contenu obligatoire de la main courante : date et heure de chaque événement ; nature de l'événement (ronde, alarme, anomalie, intervention, essai hebdomadaire, passage d'un technicien, visite d'inspection…) ; identification de l'agent (nom, prénom, numéro de badge) ; mesures prises et leur résultat ; heure de résolution ou de transmission ; signature de l'agent. Toute alarme déclenchée — même intempestive — doit être consignée avec son heure, sa cause identifiée et les mesures prises.",
        "Rondes de prévention : l'agent SSIAP1 effectue des rondes selon un planning défini par la direction de l'établissement. Lors de chaque ronde, il vérifie : l'état des extincteurs (plomb intact, pression nominale, étiquette à jour) ; l'accessibilité des sorties de secours (dégagements libres, portes non bloquées) ; la fermeture des portes coupe-feu (portes RF 30, RF 60, CF 60) ; l'état des équipements SSI (pas de voyant de défaut, pas d'inhibition non autorisée) ; l'absence de dépôts combustibles dans les zones à risque. Chaque ronde est horodatée et signée dans la main courante.",
        "Essais hebdomadaires et périodiques : l'agent SSIAP1 réalise et consigne les essais réglementaires : déclenchement manuel du SMSI (télécommande manuelle) chaque semaine ; vérification du bon fonctionnement des asservissements DAS (clapets, volets, portes) une fois par semaine ; contrôle de la signalisation lumineuse de sécurité (blocs de secours, balisage) ; essai mensuel de la source de sécurité (groupe électrogène ou batterie centrale). Toutes ces opérations sont consignées dans la main courante avec le résultat observé.",
        "Transmission et archivage : à chaque relève, l'agent sortant présente oralement et par écrit à l'agent entrant les événements de la période écoulée et les points en cours de traitement. La main courante ne doit jamais être laissée incomplète lors d'une relève. Les registres sont archivés pendant au minimum 5 ans. En cas de sinistre, la main courante est un document judiciaire — elle peut être saisie par les enquêteurs et utilisée comme preuve.",
        "Gestion des alarmes intempestives : une alarme est dite 'intempestive' lorsqu'elle se déclenche sans qu'il y ait de feu. Causes fréquentes en ERP : vapeurs de cuisine, poussières lors de travaux, fumée de cigarette, condensation sur un détecteur. Procédure : lever le doute (vérification physique de la zone) → consigner dans la main courante (heure, zone, cause présumée) → réarmer le système → informer le responsable sécurité. Une alarme intempestive répétée sur le même détecteur doit être signalée au bureau de contrôle pour maintenance. INTERDIT de neutraliser durablement un détecteur sans mesures compensatoires approuvées.",
      ],
      keyPoints: [
        "Main courante = obligation légale (arrêté 2 mai 2005, CCH R.143-33) — document judiciaire archivé 5 ans.",
        "Consigner systématiquement : rondes, alarmes, essais, anomalies, interventions, relevés.",
        "Essais hebdomadaires obligatoires : SMSI, DAS, signalisation de sécurité, source de sécurité.",
        "Relève = transmission orale + écrite. Main courante jamais incomplète lors d'une relève.",
        "Alarme intempestive : lever le doute → consigner → réarmer → signaler si répétée.",
      ],
      legalRefs: [
        "Arrêté du 2 mai 2005 modifié — Annexe V : missions et compétences de l'agent SSIAP1 (main courante).",
        "Code de la construction et de l'habitation — Art. R.143-33 : registre de sécurité en ERP.",
        "Arrêté du 25 juin 1980 modifié — Art. MS 46 : tenue du registre de sécurité.",
      ],
    },
    {
      id: "permis-feu",
      ...
      content: [
        "Définition et obligation : le permis de feu est une procédure organisationnelle qui autorise des travaux susceptibles de créer ou de propager un incendie : soudure, découpe, meulage, ponçage à chaud, utilisation d'un décapeur thermique, pose de revêtements à la flamme. Son usage est recommandé par l'INRS (ED 6030) et imposé par de nombreux règlements intérieurs en ERP. Il est obligatoire dans toutes les installations classées ICPE et recommandé dans tous les ERP recevant du public.",
        "Contenu du permis de feu : identification de l'entreprise intervenante et de l'opérateur ; description précise des travaux (nature, localisation, durée) ; identification des risques (matériaux combustibles à proximité, réseaux, faux plafonds) ; mesures de protection prises avant les travaux (dégagement, protection des matériaux combustibles, mise hors service des détecteurs de la zone concernée avec mesures compensatoires) ; matériel de lutte contre l'incendie à disposition (extincteur adapté, RIA à portée) ; durée de surveillance après travaux (minimum 1 heure après la fin, généralement 2 heures) ; signatures du responsable travaux, du donneur d'ordre et du responsable sécurité.",
        "Rôle de l'agent SSIAP1 dans le permis de feu : l'agent SSIAP1 doit être informé de tout permis de feu en cours dans l'établissement ; il surveille la zone concernée pendant et après les travaux ; il consigne dans la main courante l'heure de début, la localisation, la nature des travaux, et l'heure de fin de surveillance ; il s'assure que les mesures compensatoires (ronde renforcée, détecteur de substitution) sont bien en place si un détecteur a été inhibé ; il a l'autorité pour interrompre les travaux si les conditions de sécurité ne sont plus respectées.",
        "Inhibition temporaire de détecteur : lorsqu'un détecteur automatique doit être temporairement neutralisé pour éviter des alarmes intempestives lors de travaux, une procédure stricte s'applique : informer le responsable SSI et consigner dans la main courante ; mettre en place une mesure compensatoire (agent de surveillance en ronde renforcée sur la zone, détecteur mobile autonome) ; limiter la neutralisation à la durée strictement nécessaire ; remettre le détecteur en service et vérifier son bon fonctionnement immédiatement après la fin des travaux. Une inhibition prolongée sans mesure compensatoire constitue une faute grave.",
        "Surveillance après travaux — la règle des 2 heures : les incendies liés aux travaux par points chauds se déclarent souvent après la fin des travaux, lorsque les intervenants ont quitté les lieux. Une braise dans un interstice, une accumulation de chaleur dans une cloison ou un matelas isolant peuvent couver pendant 2 à 4 heures avant de s'embraser. La règle des 2 heures impose une ronde de surveillance de la zone des travaux toutes les 30 minutes pendant au moins 2 heures après la fin des travaux, avec consignation dans la main courante.",
      ],
      keyPoints: [
        "Permis de feu obligatoire pour tout travail par point chaud (soudure, découpe, meulage, flamme) en ERP.",
        "Contenu : identification, description travaux, mesures protection, matériel incendie, durée surveillance, signatures.",
        "Rôle SSIAP1 : être informé, surveiller, consigner, interrompre si nécessaire.",
        "Inhibition détecteur : mesure compensatoire obligatoire (ronde renforcée ou détecteur mobile).",
        "Règle des 2 heures : ronde toutes les 30 min pendant 2h après fin des travaux — risque de couvée.",
      ],
      legalRefs: [
        "INRS ED 6030 : le permis de feu.",
        "Arrêté du 25 juin 1980 modifié — Art. CH 57 : travaux dans les établissements.",
        "Code du travail — Art. R.4512-1 à R.4512-16 : coordination prévention entre entreprises (plan de prévention).",
      ],
    },
    {
      id: "synthese-ssiap",
      ...
      content: [
        ...
        "4. Effectuer les rondes de prévention selon le planning et les consigner dans la main courante.",
        "5. S'assurer en permanence que les dégagements sont libres et les portes coupe-feu fermées.",
        "6. Ne jamais inhiber un détecteur automatique sans mesure compensatoire et consignation dans la main courante.",
        "7. Appliquer la procédure permis de feu pour tout travail par point chaud — surveiller pendant et 2h après.",
        "8. Dès un début d'incendie : ALARMER en premier, avant d'attaquer ou d'évacuer.",
        "9. Alerter les secours (18) avec les informations complètes : lieu précis, nature, personnes.",
        "10. N'attaquer le feu qu'avec la voie de retraite dégagée et l'extincteur adapté à la classe.",
        "11. Accueillir les pompiers, remettre les plans et rester à leur disposition.",
        "12. Assurer la relève : transmettre oralement et par écrit tous les événements de la période.",
      ],
      keyPoints: [
        "Prévention = rondes + main courante + dégagements libres + portes CF fermées.",
        "Permis de feu : obligatoire pour tout travail par point chaud — règle des 2 heures après travaux.",
