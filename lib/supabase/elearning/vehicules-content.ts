...
export const vehiculesModuleContent: ModuleContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      visual: {
        title: "Symboles d'habilitation véhicules",
        items: [
          "B0L — Non électrique (nettoyage, manipulation)",
          "B1L / B2L — Travaux hors tension (exécutant / chargé)",
          "B1TL / B2TL — Travaux sous tension",
          "B1VL / B2VL — Travaux au voisinage",
          "B1XL / B2XL — Opérations batteries",
          "BCL — Consignation | BOL — Exploitation",
          "→ La lettre L identifie toujours un symbole véhicule",
        ],
        tone: "blue",
