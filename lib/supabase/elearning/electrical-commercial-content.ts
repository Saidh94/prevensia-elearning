  ...
  "be-vérification-mesurage": {
    ...
    sections: [
      ...
      section("roles-responsabilites", {
        ...
        content: [
          "Le titulaire BE vérification / BE Mesurage prepare un contrôle ou un mesurage selon une methode, un instrument adapte et un environnement de travail maitrise. Il sait pourquoi il mesure, ou il mesure et comment il securise l'acte de mesure.",
          "Il doit distinguer tres clairement une vérification, un mesurage, un essai simple, une lecture d'etat et une intervention de depannage. Cette frontiere conditionne la securite et la validite technique du resultat.",
          "Le role BE impose aussi une discipline documentaire: resultat exploitable, repère du point de contrôle, tracabilite minimale et signalement immédiat de tout écart qui ferait sortir l'operation du cadre prevu.",
        ],
        keyPoints: [
          "Mesurer ne veut pas dire intervenir librement.",
          "Le cadre de contrôle doit être prepare avant le geste.",
      ...
      section("preparation-travaux", {
        ...
        content: [
          "Avant de mesurer ou verifier, l'opérateur confirme le materiel concerne, le point de contrôle, la présence eventuelle de tension, le domaine de mesure attendu et l'environnement immédiat.",
          "Il vérifie aussi la cohérence entre la demande, le schema ou le repérage local, et ce qu'il voit reellement sur le terrain. Une mesure sur un mauvais depart ou dans un mauvais contexte peut être techniquement fausse et electriquement dangereuse.",
        ...
        keyPoints: [
          "Le point de mesure doit être identifie avant l'approche.",
      ...
      section("outils-protections", {
        chapterImagePath: IMG.outilsElectricien,
        intro:
          "En BE vérification / Mesurage, la fiabilite du resultat depend autant de l'instrument que du maintien d'un environnement de travail compatible avec le risque electrique.",
        content: [
          "L'opérateur contrôle l'etat apparent des instruments, des cordons, des accessoires et la compatibilite de l'ensemble avec le domaine de tension rencontre.",
          "Les EPI et EPC suivent la même logique que dans les autres habilitations: la protection collective d'abord, puis la protection individuelle. Un instrument de mesure n'autorise jamais une approche hors cadre.",
        ...
        keyPoints: [
          ...
          "Pas de contrôle fiable sans environnement maitrise.",
      ...
      section("anomalies-urgence", {
        ...
        content: [
          "Une mesure incoherente, un echauffement, un bruit anormal, une odeur ou un comportement inattendu du materiel imposent d'arreter le contrôle, de proteger la zone et de remonter l'information pour requalification.",
          "Le titulaire BE ne transforme pas une vérification en depannage spontane. Il documente, alerte et maintient la securite de la zone.",
        ],
        keyPoints: [
          "Une anomalie detectee n'autorise pas une action corrective libre.",
          "Le contrôle s'arrete des que le cadre sort du prevu.",
