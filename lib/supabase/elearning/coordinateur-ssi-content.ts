      ...
      scenarios: [
        {
          ...
          explanation: "Lors d'une mise hors service partielle du SDI, le Coordinateur SSI doit impérativement établir un plan de prévention, définir des mesures compensatoires documentées et assurer une surveillance renforcée. La NF S 61-933 encadre strictement ces procédures pour maintenir le niveau de sécurité incendie pendant les indisponibilités.",
      ...
      scenarios: [
        {
          ...
          explanation: "La mise à jour des plans SSI après travaux est une obligation réglementaire. Un schéma obsolète empêche les secours d'intervenir efficacement. Le Coordinateur SSI doit systématiquement déclencher la mise à jour documentaire dès la réception des travaux, conformément à NF S 61-932.",
      ...
      scenarios: [
        {
          ...
          explanation: "Le déclenchement intempestif d'un détecteur ne doit jamais être résolu par une simple mise hors service sans investigation. R.4227-28 impose de maintenir l'efficacité des dispositifs de détection. La bonne démarche est d'identifier la cause avec le mainteneur, de mettre en place une surveillance compensatoire et de rétablir le détecteur dès que possible.",
      ...
      scenarios: [
        {
          ...
          explanation: "La réception technique d'un SSI rénové impose des essais de bon fonctionnement documentés selon NF S 61-931. Réceptionner sans essais expose l'établissement à des non-conformités graves lors des visites de commission. Le Coordinateur SSI doit refuser toute réception sans procès-verbal d'essais complet et signé.",
      ...
      scenarios: [
        {
          ...
          explanation: "R.4512-6 impose un plan de prévention écrit dès lors que des travaux présentent des risques particuliers, notamment l'impact sur les systèmes de sécurité incendie. Le Coordinateur SSI doit initier ce document avant tout démarrage, y définir les mesures compensatoires et s'assurer que l'entreprise intervenante en a pris connaissance.",
      ...
      scenarios: [
        {
          ...
          explanation: "Face à une non-conformité critique sur le SSI, la priorité absolue est la protection des occupants : évacuation si nécessaire, surveillance humaine renforcée, notification immédiate à la direction et à la commission de sécurité. La NF S 61-933 § 6 impose une traçabilité complète des actions correctives engagées et de leurs délais.",
