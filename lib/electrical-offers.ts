...
export const electricalCommercialOffers: ElectricalCommercialOffer[] = [
  ...
  },
  {
    ...
    intraPrice: "A partir de 3 200 EUR HT / groupe (initiale) / 2 200 EUR HT / groupe (recyclage)",
    participants: "10 max",
    availability: "direct",
    ctaHref:
  ...
  },
  {
    ...
    intraPrice: "A partir de 2 900 EUR HT / groupe (initiale) / 2 000 EUR HT / groupe (recyclage)",
    participants: "Selon symbole et organisation",
    availability: "quote",
    ctaHref:
