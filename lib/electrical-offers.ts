...
export const electricalCommercialOffers: ElectricalCommercialOffer[] = [
  {
    ...
    interPrice: "180 € HT",
    intraPrice: "À partir de 790 € HT / groupe",
  ...
  },
  {
    ...
    audience: "Formation habilitation électrique pour non-électriciens",
    objective:
      "Réaliser en sécurité des interventions élémentaires de remplacement ou raccordement (BS) et des manœuvres simples d'exploitation (BE Manœuvre).",
    jobs:
    ...
    interPrice: "350 € HT (initiale) / 250 € HT (recyclage)",
    intraPrice: "À partir de 1 400 € HT / groupe (initiale) / 800 € HT / groupe (recyclage)",
    participants: "Individuel ou groupe",
    availability: "direct",
  ...
  },
  {
    ...
    jobs:
      "Professionnels du terrassement, du ripage, du nettoyage, du soutènement et des interventions de chantier au voisinage de réseaux enterrés.",
    delivery: "Parcours sur devis selon chantier, réseaux et organisation du site",
    initialDuration: "1 jour en initiale",
    recycleDuration: "1 jour en recyclage",
    interPrice: "190 € HT",
    intraPrice: "À partir de 890 € HT / groupe",
  ...
  },
  {
    ...
    jobs:
      "Électricien sur chantier électrique, technicien de maintenance, chargé d'essai, technicien polyvalent, encadrant de proximité, responsable maintenance.",
    delivery: "E-learning + journée présentielle",
    initialDuration: "3 jours en initiale",
    recycleDuration: "1,5 à 2 jours en recyclage",
    interPrice: "690 € HT (initiale) / 490 € HT (recyclage)",
    intraPrice: "À partir de 2 900 € HT / groupe (initiale) / 1 900 € HT / groupe (recyclage)",
    participants: "10 max",
    availability: "direct",
    ctaHref:
  ...
  },
  {
    ...
    jobs:
      "Électricien sur chantier électrique, technicien de maintenance sur installation bâtiment, monteur-câbleur, exécutant électrique BT.",
    delivery: "Parcours mixte e-learning + présentiel",
    initialDuration: "3 jours en initiale",
    recycleDuration: "2 jours en recyclage",
    interPrice: "590 € HT (initiale) / 390 € HT (recyclage)",
    intraPrice: "À partir de 2 300 € HT / groupe (initiale) / 1 600 € HT / groupe (recyclage)",
    ...
    detailValue: "b1-b1v",
    note:
      "Le symbole B1V suppose en plus la maîtrise des prescriptions au voisinage. Le parcours est ajusté aux travaux réels confiés.",
  },
  {
    slug: "b2-b2v",
    segment: "electriciens-bt",
    ...
    initialDuration: "3 jours en initiale",
    recycleDuration: "2 jours en recyclage",
    interPrice: "620 € HT (initiale) / 420 € HT (recyclage)",
    intraPrice: "À partir de 2 500 € HT / groupe (initiale) / 1 700 € HT / groupe (recyclage)",
    participants: "Selon symbole et organisation",
    availability: "quote",
    ctaHref:
  ...
  },
  {
    ...
    audience: "Formation habilitation électrique pour électriciens",
    objective:
      "Réaliser en sécurité des interventions de dépannage, de remplacement de matériels électriques et de connexion avec présence de tension dans le cadre BR.",
    jobs:
    ...
    recycleDuration: "2 jours en recyclage",
    interPrice: "620 € HT (initiale) / 420 € HT (recyclage)",
    intraPrice: "À partir de 2 600 € HT / groupe (initiale) / 1 800 € HT / groupe (recyclage)",
  ...
  },
  {
    ...
    initialDuration: "3 jours en initiale",
    recycleDuration: "2 jours en recyclage",
    interPrice: "560 € HT (initiale) / 390 € HT (recyclage)",
    intraPrice: "À partir de 2 200 € HT / groupe (initiale) / 1 500 € HT / groupe (recyclage)",
    ...
    detailValue: "bc",
    note:
      "Le rôle BC couvre la séquence de consignation et de déconsignation. Il doit être aligné sur les procédures du site et les missions confiées.",
  },
  {
  ...
  },
  {
    ...
    recycleDuration: "2 jours en recyclage",
    interPrice: "890 € HT (initiale) / 590 € HT (recyclage)",
