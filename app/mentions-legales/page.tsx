...
export const metadata: Metadata = {
  ...
  description: "Mentions légales de PREVENSIA FORMATION, marque de FORMACENTRE, organisme de formation certifié Qualiopi.",
...
export default function MentionsLegalesPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-sm text-slate-500">Dernière mise à jour : mai 2025</p>
      ...
      <section className="mt-10 space-y-2 text-sm text-slate-700">
        ...
        <p>
          Le site <strong>prevensia-formation.fr</strong> est édité par la société <strong>FORMACENTRE</strong>,
          dont <strong>PREVENSIA FORMATION</strong> est la marque commerciale.
        </p>
        <p><strong>Raison sociale :</strong> FORMACENTRE</p>
        <p><strong>Forme juridique :</strong> SAS — Société par actions simplifiée</p>
        <p><strong>SIREN :</strong> 933 761 363</p>
        <p><strong>SIRET (siège) :</strong> 933 761 363 00029</p>
        <p><strong>Numéro de TVA intracommunautaire :</strong> FR52933761363</p>
        <p><strong>Code NAF / APE :</strong> 85.59A — Formation continue d'adultes</p>
        <p><strong>Inscription au RCS :</strong> Greffe de Bobigny, le 11/12/2025</p>
        <p><strong>Date de création :</strong> 03/10/2024</p>
        <p><strong>Adresse du siège social :</strong> 85 rue du Docteur Sureau, 93160 Noisy-le-Grand</p>
      ...
      <section className="mt-10 space-y-2 text-sm text-slate-700">
        ...
        <p>
          ...
          FORMACENTRE / PREVENSIA FORMATION ou de ses partenaires, et est protégé par les lois françaises et internationales relatives
      ...
      <section className="mt-10 space-y-2 text-sm text-slate-700">
        ...
        <p>
          Dans le cadre de l'utilisation de ce site et de nos formations, FORMACENTRE peut être amenée à collecter des données
