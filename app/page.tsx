...
export default function Home() {
  ...
  <div className="absolute left-0 top-full z-50 hidden w-64 rounded-2xl border border-slate-200 bg-white p-3 shadow-xl group-hover:block">
    <div className="flex flex-col gap-2 text-sm text-slate-700">

      <a href="/formation-habilitation-electrique" className="rounded-lg px-3 py-2 hover:bg-slate-100 hover:text-red-700">
        Habilitation électrique
      </a>

      <a href="/formation-sst" className="rounded-lg px-3 py-2 hover:bg-slate-100 hover:text-red-700">
        Formation SST
      </a>

      <a href="/formation-securite-incendie" className="rounded-lg px-3 py-2 hover:bg-slate-100 hover:text-red-700">
        Sécurité incendie
      </a>

      <a href="/formation-sprinkler" className="rounded-lg px-3 py-2 hover:bg-slate-100 hover:text-red-700">
        Formation sprinkler
      </a>

      <a href="/formation-ssi" className="rounded-lg px-3 py-2 hover:bg-slate-100 hover:text-red-700">
        Formation SSI
      </a>
