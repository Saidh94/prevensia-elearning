  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-16 text-slate-900">
      <div className="mx-auto max-w-3xl rounded-[2rem] border border-emerald-200 bg-white p-10 shadow-sm">
        ...
        <h1 className="mt-3 text-3xl font-bold">Paiement confirme</h1>
        <p className="mt-4 text-base leading-7 text-slate-600">
          Le paiement a bien ete lance sur Stripe. La confirmation finale est
          synchronisee automatiquement avec PREVENSIA via le webhook. Si le
          badge n&apos;est pas encore passe a <strong>Paye</strong>, recharge la
