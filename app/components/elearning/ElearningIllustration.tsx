import type { IllustrationKey } from "@/lib/supabase/elearning/module-types";

export const TONE_COLORS: Record<
  string,
  { stroke: string; fillSoft: string; fillStrong: string }
> = {
  blue:  { stroke: "#2563eb", fillSoft: "#dbeafe", fillStrong: "#2563eb" },
  amber: { stroke: "#d97706", fillSoft: "#fef3c7", fillStrong: "#d97706" },
  green: { stroke: "#16a34a", fillSoft: "#dcfce7", fillStrong: "#16a34a" },
  red:   { stroke: "#dc2626", fillSoft: "#fee2e2", fillStrong: "#dc2626" },
  slate: { stroke: "#334155", fillSoft: "#e2e8f0", fillStrong: "#334155" },
};

export default function ElearningIllustration({
  illustrationKey,
  stroke,
  fillSoft,
  fillStrong,
    ...
    case "habilitation-scope":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="90" y="65" textAnchor="middle" fontSize="16" fontWeight="700" fill={stroke}>H0B0</text>
          ...
          <text x="90" y="155" textAnchor="middle" fontSize="12" fill={stroke}>Personnel non électricien</text>
          <rect x="250" y="30" width="150" height="150" rx="18" fill="white" stroke={stroke} strokeWidth="3" />
          <text x="325" y="60" textAnchor="middle" fontSize="15" fontWeight="700" fill={stroke}>Zone électrique</text>
    ...
    case "electric-risk":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="80" y="55" textAnchor="middle" fontSize="13" fontWeight="700" fill={stroke}>Contact direct</text>
          ...
          <text x="210" y="55" textAnchor="middle" fontSize="13" fontWeight="700" fill={stroke}>Contact indirect</text>
          ...
          <text x="340" y="55" textAnchor="middle" fontSize="13" fontWeight="700" fill={stroke}>Voisinage</text>
    ...
    case "body-effects":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="335" y="58" textAnchor="middle" fontSize="14" fontWeight="700" fill={stroke}>Effets possibles</text>
    ...
    case "work-environment":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="95" y="60" textAnchor="middle" fontSize="14" fontWeight="700" fill={stroke}>Local technique</text>
          ...
          <text x="178" y="115" textAnchor="middle" fontSize="18" fontWeight="700" fill={stroke}>!</text>
        </svg>
      );
    ...
    case "authorized-forbidden":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="107" y="58" textAnchor="middle" fontSize="15" fontWeight="700" fill={stroke}>Autorisé</text>
          ...
          <text x="312" y="58" textAnchor="middle" fontSize="15" fontWeight="700" fill={stroke}>Interdit</text>
    ...
    case "emergency-response":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="75" y="112" textAnchor="middle" fontSize="16" fontWeight="700" fill={stroke}>STOP</text>
          ...
          <text x="350" y="106" textAnchor="middle" fontSize="14" fontWeight="700" fill={stroke}>ALERTE</text>
        </svg>
      );
    ...
    case "summary-reflexes":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="90" y="104" textAnchor="middle" fontSize="14" fontWeight="700" fill={stroke}>OBSERVER</text>
          <circle cx="210" cy="110" r="48" fill="white" stroke={stroke} strokeWidth="4" />
          <text x="210" y="104" textAnchor="middle" fontSize="14" fontWeight="700" fill={stroke}>NE PAS</text>
          <text x="210" y="124" textAnchor="middle" fontSize="14" fontWeight="700" fill={stroke}>IMPROVISER</text>
          <circle cx="330" cy="110" r="48" fill="white" stroke={stroke} strokeWidth="4" />
          <text x="330" y="104" textAnchor="middle" fontSize="14" fontWeight="700" fill={stroke}>ALERTER</text>
