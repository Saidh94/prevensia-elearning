    ...
    case "habilitation-scope":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          />
          <path
            d="M325 94 L314 115 H328 L318 128"
            stroke={fillStrong}
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
    ...
    case "electric-risk":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <path
            d="M116 63 L125 73 L117 73 L123 83"
            stroke={fillStrong}
            strokeWidth="3"
            fill="none"
          />
    ...
    case "body-effects":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          <text x="320" y="93" fontSize="12" fill={stroke}>
            Brûlures
          </text>
          <circle cx="305" cy="113" r="5" fill={fillStrong} />
          <text x="320" y="118" fontSize="12" fill={stroke}>
            Tétanisation
          </text>
          <circle cx="305" cy="138" r="5" fill={fillStrong} />
          <text x="320" y="143" fontSize="12" fill={stroke}>
            Troubles cardiaques
          </text>
        </svg>
      );
    ...
    case "authorized-forbidden":
      return (
        <svg viewBox="0 0 420 220" className="h-56 w-full">
          ...
          />
          <path
            d="M61 95 L68 102 L80 88"
            stroke={fillStrong}
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
          />
          <text x="98" y="100" fontSize="12" fill={stroke}>
            Observer
          </text>
          <circle
            cx="70"
          ...
          />
          <path
            d="M61 128 L68 135 L80 121"
            stroke={fillStrong}
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
          />
          <text x="98" y="133" fontSize="12" fill={stroke}>
            Signaler
          </text>
          <circle
            cx="70"
          ...
          />
          <path
            d="M61 161 L68 168 L80 154"
            stroke={fillStrong}
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
          />
          <text x="98" y="166" fontSize="12" fill={stroke}>
            Alerter
          </text>
          ...
          <text x="305" y="105" fontSize="12" fill={stroke}>
            Ouvrir / réparer
          </text>
          <circle
            cx="275"
          ...
          <text x="305" y="150" fontSize="12" fill={stroke}>
            Improviser
          </text>
        </svg>
      );
...
export default function VisualCard({
  ...
  const hasImageError =
    imageErrorState.imagePath === imagePath
      ? imageErrorState.hasError
      : false;
