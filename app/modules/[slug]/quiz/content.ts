...
quizContent["ssi-exploitation"] = [
  ...
  },
  {
    ...
    answer: [1],
    chapterLabel: "Composants SSI",
    explanation: "Une Zone de Détection est un découpage du bâtiment associé à un groupe de détecteurs. Lorsqu'un détecteur se déclenche, la centrale localise l'alarme dans la ZDA ou ZDM correspondante. Plus les ZDA/ZDM sont petites, plus la localisation est précise, facilitant la levée de doute et l'intervention.",
    timeLimit: 40,
  },
  {
    question: "Une Zone de Mise en Sécurité (ZS) différente de la Zone de Détection (ZDA/ZDM) signifie :",
    choices: [
      "Une erreur de conception du SSI",
      "Que les actions de sécurité ne correspondent pas aux zones détectées",
      "Qu'une détection dans une ZDA ou ZDM peut commander des actions de sécurité dans une ou plusieurs ZS différentes",
      "Que le désenfumage est indépendant de la détection",
    ],
    answer: [2],
    chapterLabel: "Composants SSI",
    explanation: "Les ZDA/ZDM et ZS peuvent être différentes selon la conception du bâtiment. Par exemple, une détection dans une ZDA peut commander le désenfumage d'une ZF adjacente pour confiner la fumée, ou fermer des clapets dans une ZC. L'exploitant doit connaître ces correspondances via la matrice de corrélation.",
    timeLimit: 45,
  },
  {
...
quizContent["coordinateur-ssi"] = [
  // ── NF S 61-931 : Architecture ──
  {
    ...
    timeLimit: 45,
    imagePath: "/elearning/coordinateur-ssi/coord-ssi-architecture.svg",
    imageAlt: "Schéma bloc architecture SSI — SDI, ECS, CMSI, DAS, UGA",
  },
  {
  ...
  },
  {
    ...
    timeLimit: 40,
    imagePath: "/elearning/coordinateur-ssi/coord-ssi-zones.svg",
    imageAlt: "Plan de principe SSI — zones de détection, désenfumage, compartimentage, alarme",
  },
  // ── NF S 61-932 : CMSI ──
  {
  ...
  // ── CCF, Matrice de corrélation, Dossier d'Identité SSI ──
  {
    question: "Le Cahier des Charges Fonctionnel SSI (CCF) est rédigé par le CSSI :",
    choices: [
      "Après que l'installateur a câblé les détecteurs, pour documenter l'existant",
      "Avant la consultation des entreprises — c'est un document contractuel que l'installateur doit respecter",
      "Uniquement lors de la réception, pour valider la conformité",
      "Par le bureau de contrôle lors de la vérification périodique",
    ],
    answer: [1],
    chapterLabel: "CCF et Matrice de Corrélation",
    explanation: "Le CCF est le document fondateur de la mission du CSSI (NF S 61-931 §5.3.2.1). Il définit les Zones de Détection, les Zones de Mise en Sécurité, les DAS associés, les temporisations et les scénarios de mise en sécurité AVANT que l'installateur intervienne. Rédiger le CCF après l'installation est une pratique non conforme.",
    timeLimit: 45,
    imagePath: "/elearning/coordinateur-ssi/coord-ssi-ccf.svg",
    imageAlt: "Structure du CCF et place dans le cycle de vie du SSI",
  },
  {
    question: "La matrice de corrélation SSI (NF S 61-931) définit :",
    choices: [
      "Les délais d'intervention du mainteneur selon le type de panne",
      "Pour chaque Zone de Détection, quels DAS sont actionnés et avec quelles temporisations",
      "Le budget prévisionnel de maintenance annuelle du SSI",
      "Les coordonnées des prestataires de sécurité incendie",
    ],
    answer: [1],
    chapterLabel: "CCF et Matrice de Corrélation",
    explanation: "La matrice de corrélation est le tableau croisé ZDA/ZDM × DAS : elle précise, pour chaque zone de détection activée, quels dispositifs actionnés de sécurité passent en position de sécurité et avec quelle temporisation. C'est le CSSI qui la conçoit dans le CCF — c'est l'installateur qui la programme dans le CMSI.",
    timeLimit: 45,
    imagePath: "/elearning/coordinateur-ssi/coord-ssi-matrice.svg",
    imageAlt: "Exemple de matrice de corrélation SSI",
  },
  {
    question: "Le Dossier d'Identité SSI (DIS), produit par le CSSI en phase de réception, contient :",
    choices: [
      "Uniquement les contrats de maintenance des équipements",
      "Les plans as-built, le CCF définitif, la matrice validée, les fiches DAS et les PV d'essais fonctionnels",
      "La liste des agents SSIAP affectés à l'établissement",
      "Les factures des entreprises intervenantes",
    ],
    answer: [1],
    chapterLabel: "Dossier d'Identité SSI",
    explanation: "Le DIS (NF S 61-931 §5.3.2.3) est le livrable final de la mission du CSSI en réception. Il comprend : notice descriptive, plans AS-BUILT (ZDA/ZDM, ZF, ZC), CCF définitif, matrice de corrélation validée, fiches techniques DAS, PV d'essais fonctionnels, certificats de conformité des équipements. Il est remis à l'exploitant et présenté à la commission de sécurité.",
    timeLimit: 45,
    eliminatory: false,
  },
